...
@curl -L https://raw.github.com/ig10/oh-my-zsh/master/tools/install.sh | sh@

h4. via `wget`

@wget --no-check-certificate https://raw.github.com/ig10/oh-my-zsh/master/tools/install.sh -O - | sh@
...
@curl -L https://raw.github.com/ig10/oh-my-zsh/master/tools/install.sh | ZSH=~/.dotfiles/zsh sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/ig10/oh-my-zsh.git ~/.oh-my-zsh@
